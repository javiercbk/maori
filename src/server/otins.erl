...
otins({ins,{Node,Parent1}},{ins,{Node,Parent2}}) when Parent1 =/= Parent2 ->
    ok_response({ins,{Node,Parent2}},{ins,{Node,Parent1}});
%%different nodes same parent
otins({ins,{Node1,Parent}},{ins,{Node2,Parent}}) when Node1 =/= Node2->
...
otins({ins,{Node1,Parent}},{rel,{Node,Node}}) ->
    warning_response(nop, {ins,{Node1,Parent}});
%% ins Node is the second rel node
...
otins({ins,{Node1,Parent}},{brk,{Node,Node}}) ->
    warning_response(nop, {ins,{Node1,Parent}});
%%insert Node into Parent and break Node from Node1
otins({ins,{Node,Parent}},{brk,{Node,Node1}}) when Node =/= Node1->
    ok_response({brk,{Node,Node1}}, {ins,{Node,Parent}});
%%insert Node into Parent and break Node from Node1
otins({ins,{Node,Parent}},{brk,{Node1,Node}}) when Node =/= Node1->
    ok_response({brk,{Node1,Node}}, {ins,{Node,Parent}});
%%insert a Node into Parent and break Node1 from Node2
otins({ins,{Node,Parent}},{brk,{Node1,Node2}}) when Node =/= Node1, Node =/= Node2, Node1 =/= Node2->
...
otins({ins,{Node,Parent}},{del,{Node,Parent1}}) when Parent =:= Parent1->
    ok_response(nop, {ins,{Node,Parent}});
